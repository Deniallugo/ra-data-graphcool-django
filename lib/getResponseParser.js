...
var sanitizeResource = function sanitizeResource(introspectionResults, resource, aorFetchType) {
...
exports.default = function (introspectionResults) {
    return function (aorFetchType, resource) {
        return function (response) {
            var sanitize = sanitizeResource(introspectionResults, resource, aorFetchType);
